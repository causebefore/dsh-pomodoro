    ...
    function apply(ctx) {
      ...
      function PomodoroPanel() {
        ...
        const phaseText = st.phase === "focus"
          ? (st.running ? "专注中" : "专注")
          : (st.running ? "休息中" : "休息");
        const miniTitle = flashOn
          ? (st.phase === "break" ? "☕ 休息一下" : "🍅 开始专注")
          : (st.phase === "break" ? "☕ " : "🍅 ") + phaseText;
        ...
        return react.createElement(
          ...
          react.createElement(
            ...
            react.createElement("span", {
              ...
              role: st.compact ? "status" : undefined,
              "aria-live": st.compact ? "polite" : undefined,
          ...
          !st.compact && flashOn ? react.createElement("div", { className: "pomo-flash", role: "status", "aria-live": "polite" }, flashText) : null,
          st.compact
            ? react.createElement(
              "div",
