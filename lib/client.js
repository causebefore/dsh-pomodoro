...
.pomo-card-name { font: var(--dsw-font-s-strong-14); color: var(--dsw-alias-label-primary); }
...
@media (prefers-reduced-motion: reduce) { .pomo-flash { animation: none; } .pomo-ring-fg, .pomo-settings-card, .pomo-card-chevron { transition: none; } }
`;
