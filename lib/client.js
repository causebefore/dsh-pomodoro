...
`;
    ...
    function apply(ctx) {
      ...
      // rc.7 起 settings.plugin.item 为 keyed slot（key=设置命名空间）；保留 id 兼容 rc.6 的 list slot。
      slots.inject("settings.plugin.item", () => slots.register(
        { name: "settings.plugin.item", id: "pomodoro", key: POMODORO_LOCALE_NS, order: 30, locale: POMODORO_LOCALE_NS },
